...
export const PROCESS_GROUPS = [
  ...
  },
  {
    ...
    procesos: [
      { id: 'laminado',   nombre: 'Laminado',   desc: 'Costo por m² · Tiro y retiro por separado', defaultCost: 0, customLayout: true, extras: { tiroActive: false, tiroTipoLaminado: 'Mate', tiroPrecioM2: 4200, tiroChargeMode: 'fijo', tiroValorBase: 0, retiroActive: false, retiroTipoLaminado: 'Mate', retiroPrecioM2: 4200, retiroChargeMode: 'fijo', retiroValorBase: 0 } },
